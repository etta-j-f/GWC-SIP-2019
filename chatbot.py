...
def greet():
    print("---------------------------------------")
    greetings = ["Howdy!", "Hey, there!", "Hello!", "Hey man.", "What's poppin' Jimbo?", "WHAT'S SHAKIN BACON"]
...
def feeling():
    ...
    if feel.lower() == "good":
        ...
        print("Yeah, me too.")
def talk():
    randomfoods = ["Good choice! My favorite food is mac and cheese!", "I hate mayonnaise", "Soda makes my keys sticky", "Water makes me short circuit", "Pizza is the BEST"]
    ...
    if topic == "food":
        ...
        genre = genre.lower()
        if genre == "pop":
            print("Same! I like Billie Eilish, Lizzo, and Ed Sheeran.")
        elif genre == "alternative" or genre == "rock":
